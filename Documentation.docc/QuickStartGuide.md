...
1. Read <doc:Architecture> for detailed architecture patterns
2. Review <doc:FolderStructure> for complete structure details
3. Check <doc:Patterns> for design patterns
4. Follow <doc:DataFlow> to understand data flow
5. Set up API integration using <doc:APIIntegration>
